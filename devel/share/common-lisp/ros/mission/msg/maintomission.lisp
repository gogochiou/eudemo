...
(cl:defmethod cl:initialize-instance :after ((m <maintomission>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'maintomission)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mission-msg:<maintomission> is deprecated: use mission-msg:maintomission instead.")))

(cl:ensure-generic-function 'team-val :lambda-list '(m))
(cl:defmethod team-val ((m <maintomission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mission-msg:team-val is deprecated.  Use mission-msg:team instead.")
  (team m))

(cl:ensure-generic-function 'action-val :lambda-list '(m))
(cl:defmethod action-val ((m <maintomission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mission-msg:action-val is deprecated.  Use mission-msg:action instead.")
  (action m))

(cl:ensure-generic-function 'planer_state-val :lambda-list '(m))
(cl:defmethod planer_state-val ((m <maintomission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mission-msg:planer_state-val is deprecated.  Use mission-msg:planer_state instead.")
  (planer_state m))

(cl:ensure-generic-function 'action_pos-val :lambda-list '(m))
(cl:defmethod action_pos-val ((m <maintomission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mission-msg:action_pos-val is deprecated.  Use mission-msg:action_pos instead.")
  (action_pos m))

(cl:ensure-generic-function 'cup-val :lambda-list '(m))
(cl:defmethod cup-val ((m <maintomission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mission-msg:cup-val is deprecated.  Use mission-msg:cup instead.")
  (cup m))

(cl:ensure-generic-function 'hand-val :lambda-list '(m))
(cl:defmethod hand-val ((m <maintomission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mission-msg:hand-val is deprecated.  Use mission-msg:hand instead.")
  (hand m))

(cl:ensure-generic-function 'reef-val :lambda-list '(m))
(cl:defmethod reef-val ((m <maintomission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mission-msg:reef-val is deprecated.  Use mission-msg:reef instead.")
  (reef m))

(cl:ensure-generic-function 'NS-val :lambda-list '(m))
(cl:defmethod NS-val ((m <maintomission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mission-msg:NS-val is deprecated.  Use mission-msg:NS instead.")
  (NS m))

(cl:ensure-generic-function 'emerg-val :lambda-list '(m))
(cl:defmethod emerg-val ((m <maintomission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mission-msg:emerg-val is deprecated.  Use mission-msg:emerg instead.")
  (emerg m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<maintomission>)))
  ...
  (cl:format cl:nil "int32 team~%int32 action~%int32 planer_state~%float32[] action_pos~%int32[] cup #[0] for cup num; [1] for hand num~%int32[] hand #for hand status~%int32[] reef~%bool NS~%bool emerg~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'maintomission)))
  "Returns full string definition for message of type 'maintomission"
  (cl:format cl:nil "int32 team~%int32 action~%int32 planer_state~%float32[] action_pos~%int32[] cup #[0] for cup num; [1] for hand num~%int32[] hand #for hand status~%int32[] reef~%bool NS~%bool emerg~%~%"))
