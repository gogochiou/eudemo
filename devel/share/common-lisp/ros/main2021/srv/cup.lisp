...
(cl:defmethod cl:initialize-instance :after ((m <cup-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cup-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name main2021-srv:<cup-request> is deprecated: use main2021-srv:cup-request instead.")))

(cl:ensure-generic-function 'ask_cup-val :lambda-list '(m))
(cl:defmethod ask_cup-val ((m <cup-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main2021-srv:ask_cup-val is deprecated.  Use main2021-srv:ask_cup instead.")
  (ask_cup m))
...
(cl:defmethod cl:initialize-instance :after ((m <cup-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cup-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name main2021-srv:<cup-response> is deprecated: use main2021-srv:cup-response instead.")))

(cl:ensure-generic-function 'cup_result-val :lambda-list '(m))
(cl:defmethod cup_result-val ((m <cup-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main2021-srv:cup_result-val is deprecated.  Use main2021-srv:cup_result instead.")
  (cup_result m))
