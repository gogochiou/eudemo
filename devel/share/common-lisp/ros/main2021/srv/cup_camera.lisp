...
(cl:defmethod cl:initialize-instance :after ((m <cup_camera-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cup_camera-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name main2021-srv:<cup_camera-request> is deprecated: use main2021-srv:cup_camera-request instead.")))

(cl:ensure-generic-function 'req-val :lambda-list '(m))
(cl:defmethod req-val ((m <cup_camera-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main2021-srv:req-val is deprecated.  Use main2021-srv:req instead.")
  (req m))
...
(cl:defmethod cl:initialize-instance :after ((m <cup_camera-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cup_camera-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name main2021-srv:<cup_camera-response> is deprecated: use main2021-srv:cup_camera-response instead.")))

(cl:ensure-generic-function 'color-val :lambda-list '(m))
(cl:defmethod color-val ((m <cup_camera-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main2021-srv:color-val is deprecated.  Use main2021-srv:color instead.")
  (color m))

(cl:ensure-generic-function 'cup_pos-val :lambda-list '(m))
(cl:defmethod cup_pos-val ((m <cup_camera-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main2021-srv:cup_pos-val is deprecated.  Use main2021-srv:cup_pos instead.")
  (cup_pos m))
